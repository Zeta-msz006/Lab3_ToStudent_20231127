...
if __name__ == '__main__':
    ...
    detector.setInputSize([img3.shape[1], img2.shape[0]])
    face3 = detector.infer(img3)
    assert face3.shape[0] > 0, 'Cannot find a face in {}'.format(args.input3)
...
plt.imshow(cv.cvtColor(result, cv.COLOR_RGB2BGR)) 